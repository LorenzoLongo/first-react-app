    ...
    render() {
        ...
        return (
            <div>
                ...
                <Paginator currentPage={currentPage} pageCount={pageCount} setPage={this.changePage.bind(this)} nextPage={this.onNextPageClick.bind(this)} previousPage={this.onPreviousPageClick.bind(this)}/>
            </div>
        )
    }
}

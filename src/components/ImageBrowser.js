                        ...
                        return (
                            ...
                            <div className="col-md-6 col-lg-4">
                                <div className="mt-2 mb-2">
                                    <img src={`http://localhost:800${image.url}`} className="img-fluid"/>
                                </div>
                                <div className="mb-2">
                                    <button type="button" className="btn btn-outline-danger btn-sm" onClick={onImageDeleteClick} disabled={isLocked}>Remove</button>
                                </div>
                            </div>
                            </CSSTransition>
                        )

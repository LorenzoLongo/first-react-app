...
class RegisterForm extends React.Component {
    ...
    onSubmit(values) {
        return this.props.userRegister(...Object.values(values)).then(() => {
            this.props.reset();
            ...
            <div className="card mt-3 mb-5 shadow-sm">
                <div className="card-body">
                    <form onSubmit={handleSubmit(this.onSubmit.bind(this))}>
                        ...
                        <Field name="fullname" label="Fullname:" type="text" component={renderField}/>
                        ...
                        <button type="submit" className="btn btn-primary btn-block" disabled={submitting || !this.state.termsAccepted}>Register</button>
                    </form>
                </div>
            </div>
        )
